...
SQLALCHEMY_DATABASE_URI = 'postgresql://csrweb:csrweb@localhost/csrweb'
SQLALCHEMY_TRACK_MODIFICATIONS = False

CELERY_BROKER_URL = 'amqp://csrweb:csrweb@localhost:5672/ideweb_vhost'
CELERY_RESULT_BACKEND = 'db+postgresql://csrweb:csrweb@localhost:5432/csrweb'
